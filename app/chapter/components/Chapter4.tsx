...
import { chapter4sr } from "@/app/data/sr/chapter-4";
import { chapter4en } from "@/app/data/en/chapter-4";
...
function page() {
  ...
  const chapter = language === "sr" ? chapter4sr : chapter4en;
  ...
  before:bg-[url('/images/background/10.webp')]
          ...
          {chapter.pages.map((page, index) => (
            ...
            >
              ...
              <div className="absolute w-full h-screen bg-no-repeat bg-cover">
                <Image
                  src={`/images/line/chapter4-0${index + 1}.png`}
                  alt=""
                  fill
                  priority
                ...
                {index === 0 && (
                  <>
                    ...
                    <h1 className="absolute flex flex-col text-(--imscrvena) text-5xl mt-85 ml-20">
                      {language === "sr" ? (
                        <>
                          <span className="ml-10">У служби</span>
                          <span className="ml-18 mt-2">отачаства</span>
                        </>
                      ) : (
                        <>
              ...
              <PhotoAnimation index={index}>
                {page.image && (
                  ...
                  >
                    <Image
                      src={`/images/chapter-4/0${page.image.name}.webp`}
                      alt=""
              ...
              {index === chapter.pages.length - 1 && (
                <>
                  <div
                    className={`absolute top-325 left-190 flex flex-col items-center cursor-pointer z-50`}
