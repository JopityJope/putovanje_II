                ...
                {index === 0 && (
                  <ChapterAnimation index={index}>
                    ...
                    <h1 className="absolute flex flex-col text-(--imscrvena) text-5xl mt-85 ml-20">
                      {language === "sr" ? (
                        <>
                          <span className="ml-10">Из разоноде или на</span>
                          <span className="ml-18 mt-2">трагу авантуре</span>
                        </>
                      ) : (
                        <>
                          <span className="ml-10">Seeking amusement</span>
                          <span className="ml-18 mt-2">or adventure</span>
                        </>
                      )}
                    </h1>
                  </ChapterAnimation>
