  ...
  return (
    <div className="fixed w-screen top-460 left-0 pb-5 pr-13 z-30 flex flex-row gap-4 flex">
      ...
      <div className="absolute w-screen flex z-30 justify-between  items-start   ">
        <div className="flex gap-20 pl-20 -translate-y-6">
          <div className="flex flex-col items-center text-sm">
            ...
            <p className="absolute text-(--imscrvena) top-[38] max-w-25 text-center text-xs">
          ...
          <div className="flex flex-col items-center text-sm">
            ...
            <p className="absolute text-(--crna) top-[38] max-w-25 text-center text-xs">
              У потрази за дукатом више
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-sm">
            ...
            <p className="absolute text-(--crna) top-[38] max-w-30 text-center text-xs">
          ...
          <div className="flex flex-col items-center text-sm">
            ...
            <p className="absolute text-(--crna) top-[38] max-w-50 text-center text-xs">
              Жена и путовање
            </p>
          </div>
        </div>
